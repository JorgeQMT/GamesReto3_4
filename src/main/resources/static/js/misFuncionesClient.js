...
function traerInformacionClientes(){
    $.ajax({
        url:"http://140.238.236.229:8080/api/Client/all", //colocar la http del modulo de la tabla CLIENT
        type:"GET",
        datatype:"JSON",
...
function guardarElementoClient(){
    ...
    $.ajax({
        ...
        url:"http://140.238.236.229:8080/api/Client/save",
...
function actualizarElementoClient(idElementoC){
    ...
    $.ajax({
        url:"http://140.238.236.229:8080/api/Client/update", //colocar la http del modulo de la tabla CLIENT
        type:"PUT",
        data:dataToSend,
...
function borrarElementoClient(idElementoC){
    ...
    let dataToSend=JSON.stringify(myDataC);
    $.ajax({
        url:"http://140.238.236.229:8080/api/Client/"+idElementoC,
        type:"DELETE",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
