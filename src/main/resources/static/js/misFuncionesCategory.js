...
function guardarElementoCategory(){
    ...
    $.ajax({
        ...
        url:"http://140.238.236.229:8080/api/Category/save",
...
function actualizarElementoCategory(idElemento){
    ...
    $.ajax({
        url:"http://140.238.236.229:8080/api/Category/update", //colocar la http del modulo de la tabla CLIENT
        type:"PUT",
        data:dataToSend,
...
function borrarElementoCategory(idElemento){
    ...
    let dataToSend=JSON.stringify(myData);
    $.ajax({
        url:"http://140.238.236.229:8080/api/Category/"+idElemento,
        type:"DELETE",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
