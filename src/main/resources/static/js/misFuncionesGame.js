...
function traerInformacionC(){
    $.ajax({
        url:"http://140.238.236.229:8080/api/Category/all",
        type:"GET",
        datatype:"JSON",
...
function guardarElementoGame(){
    ...
    $.ajax({
        ...
        url:"http://140.238.236.229:8080/api/Game/save",
...
function actualizarElementoGame(idElemento){
    ...
    $.ajax({
        url:"http://140.238.236.229:8080/api/Game/update", //colocar la http del modulo de la tabla CLIENT
        type:"PUT",
        data:dataToSend,
...
function borrarElementoGame(idElemento){
    ...
    let dataToSend=JSON.stringify(myData);
    $.ajax({
        url:"http://140.238.236.229:8080/api/Game/"+idElemento,
        type:"DELETE",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
